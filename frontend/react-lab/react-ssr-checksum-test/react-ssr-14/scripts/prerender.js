// https://raw.githubusercontent.com/ewnd9/anki-apkg-export-app/master/render-once.js
'use strict';

const htmlPath = './dist/index.html';

const resourceFrom = '/'; // github pages project subpath
const resourceTo = './dist/'; // dist folder with files
